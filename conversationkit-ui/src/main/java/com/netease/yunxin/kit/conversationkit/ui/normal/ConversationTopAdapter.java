...
import com.netease.yunxin.kit.conversationkit.ui.normal.viewholder.ConversationTopViewHolder;
...
public class ConversationTopAdapter extends RecyclerView.Adapter<ConversationTopViewHolder> {
  ...
  public ConversationTopViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ConversationTopItemBinding binding =
        ConversationTopItemBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
