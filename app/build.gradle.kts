...
//    implementation(project(":searchkit-ui"))
    ...
    implementation("com.netease.yunxin.kit.qchat:qchatkit-ui:9.2.0")
    implementation("com.netease.yunxin.kit.conversation:conversationkit-ui:9.2.0")
    implementation("com.netease.yunxin.kit.team:teamkit-ui:9.2.0")
    implementation("com.netease.yunxin.kit.chat:chatkit-ui:9.2.0")
    implementation("com.netease.yunxin.kit.search:searchkit-ui:9.2.0")
