...
public class AIUserSelectorAdapter
    extends BaseAIUserSelectorAdapter<AiUserSelectorViewHolderBinding> {

  @Override
  protected AiUserSelectorViewHolderBinding provideViewBinding(
      @NonNull ViewGroup parent, int viewType) {
    return AiUserSelectorViewHolderBinding.inflate(
        LayoutInflater.from(parent.getContext()), parent, false);
  }

  @Override
  protected void handleBindViewHolder(
      BaseSelectableViewHolder<AiUserSelectorViewHolderBinding> holder,
