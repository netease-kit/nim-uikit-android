...
public class IndexBarDataHelperImpl implements IIndexBarDataHelper {
    ...
    public IIndexBarDataHelper sortSourceData(List<? extends IndexPinyinBean> data) {
        ...
        fillIndexTag(data);
        //对数据源进行排序
        Collections.sort(data, (Comparator<IndexPinyinBean>) (lhs, rhs) -> {
    ...
    @Override
    public IIndexBarDataHelper getSortedIndexData(List<? extends IndexPinyinBean> sourceData, List<String> data) {
