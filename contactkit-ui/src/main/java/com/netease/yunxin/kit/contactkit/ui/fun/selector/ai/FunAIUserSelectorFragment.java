...
import com.netease.yunxin.kit.contactkit.ui.databinding.FunAiUserSelectorLayoutBinding;
...
/** AI用户选择器 选择AI数字人 */
public class FunAIUserSelectorFragment extends BaseAISelectorFragment {

  FunAiUserSelectorLayoutBinding binding;

  @Override
  protected View getRootView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container) {
    binding = FunAiUserSelectorLayoutBinding.inflate(inflater, container, false);
  ...
  protected BaseAIUserSelectorAdapter provideAdapter() {
    return new FunAIUserSelectorAdapter();
  }
}
