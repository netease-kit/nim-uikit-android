...
public class UserInfoActivity extends BaseActivity {
  ...
  private void initView() {
    binding.contactUser.setUserCallback(
    ...
    binding.contactUser.setCommentClickListener(
        v -> {
          if (userInfoData == null || userInfoData.data == null) {
            return;
          }
          ...
          intent.putExtra(
              CommentActivity.REQUEST_COMMENT_NAME_KEY, userInfoData.friendInfo.getAlias());
          commentLauncher.launch(intent);
        });

    binding.contactUser.setDeleteClickListener(
        v -> {
          if (userInfoData == null || userInfoData.data == null) {
            return;
          }
