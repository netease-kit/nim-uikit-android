...
/**
 * helper for indexBar and data
 * 1 translate Chinese characters to pinyin
 * 2 fill indexTag
 * 3 sort source data
 * 4 source data after sort->indexBar source data
 */
...
public interface IIndexBarDataHelper {
    ...
    IIndexBarDataHelper getSortedIndexData(List<? extends IndexPinyinBean> sourceData, List<String> data);
}
