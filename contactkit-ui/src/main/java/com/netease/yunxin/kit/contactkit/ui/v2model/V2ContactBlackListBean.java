...
public class V2ContactBlackListBean extends BaseContactBean {

  public V2UserInfo data;
  public UserWithFriend friendInfo;

  public V2ContactBlackListBean(V2UserInfo data) {
    this.data = data;
  ...
  public boolean equals(@Nullable Object obj) {
    if (obj instanceof V2ContactBlackListBean) {
      return data.getAccountId().equals(((V2ContactBlackListBean) obj).data.getAccountId());
    }
    return false;
  }
