...
import com.netease.yunxin.kit.contactkit.ui.databinding.FunRobotListActivityLayoutBinding;
...
/** Fun 版机器人列表页面 */
public class FunRobotListActivity extends BaseRobotListActivity {

  @Override
  protected void initViews() {
    changeStatusBarColor(R.color.color_white);
    FunRobotListActivityLayoutBinding binding =
        FunRobotListActivityLayoutBinding.inflate(getLayoutInflater());
    ...
    adapter = new RobotListAdapter(R.layout.fun_robot_list_item_layout);
  ...
  protected String getCreateRobotRouterPath() {
    return RouterConstant.PATH_FUN_MY_ROBOT_CREATE_PAGE;
  }
