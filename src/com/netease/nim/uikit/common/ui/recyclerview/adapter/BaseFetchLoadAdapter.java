...
public abstract class BaseFetchLoadAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> implements IRecyclerView {
        ...
        if (recyclerView != null) {
            ...
            if (layoutManager instanceof LinearLayoutManager) {
                ...
                if (firstItemPosition == 0) {
                    ...
                    recyclerView.scrollToPosition(newData.size() + getFetchMoreViewCount());
                }
            } else {
                recyclerView.scrollToPosition(newData.size());
            }
        }
    }
    ...
    public void remove(int position) {
        ...
        notifyItemRemoved(position + getFetchMoreViewCount());
    }

    /**
     * add new data to head location
     */
    private void addFrontData(List<T> data) {
     ...
     * @param newData
     */
    private void appendData(List<T> newData) {
