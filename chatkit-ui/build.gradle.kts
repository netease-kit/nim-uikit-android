...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "versionName", "\"10.9.27-beta01\"")
    }
...
//    api(project(":common-ui"))
    ...
    api("com.netease.yunxin.kit.chat:chatkit:10.9.27-beta01")
    api("com.netease.yunxin.kit.core:corekit-plugin:1.14.0")
