...
import com.netease.yunxin.kit.chatkit.ui.databinding.FunChatThumbnailPinViewHolderBinding;
import com.netease.yunxin.kit.chatkit.ui.model.ChatMessageBean;
import com.netease.yunxin.kit.common.ui.widgets.ShapeDrawable;
import com.netease.yunxin.kit.common.utils.ScreenUtils;

/** view holder to show image/video thumb */
public abstract class FunChatThumbPinViewHolder extends FunChatBasePinViewHolder {
  private static final String TAG = "ChatThumbBaseViewHolder";

  FunChatThumbnailPinViewHolderBinding binding;

  public FunChatThumbPinViewHolder(@NonNull FunChatBasePinViewHolderBinding parent, int viewType) {
  ...
  private void load() {
    ...
    if (!TextUtils.isEmpty(thumbPath)) {
      ...
      ChatObserverRepo.registerAttachmentProgressObserve(
                ...
                if (binding != null) {
                  binding
                      ...
                      .post(
                          () ->
                              loadThumbnailImage(
                                  TextUtils.isEmpty(attachment.getPath())
                                      ? attachment.getThumbPath()
                                      : thumbFromSourceFile(attachment.getPath())));
                }
              }
            }
          });
