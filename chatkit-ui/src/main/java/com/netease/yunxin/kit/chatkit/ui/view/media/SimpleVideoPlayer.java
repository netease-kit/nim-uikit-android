...
public class SimpleVideoPlayer extends ConstraintLayout {
    private final static String TAG = "SimpleVideoPlayer";
    ...
    public SimpleVideoPlayer(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    void init() {
        ...
        binding.videoProgressAction.setOnClickListener(v -> {
    ...
    private void initCountDownTimer(long millisInFuture) {
        actionsCountDown = new CountDownTimer(millisInFuture, 1000) {
            @Override
