...
public class ChatCallMessageViewHolder extends ChatBaseMessageViewHolder {
  ...
  ChatMessageCallViewHolderBinding callBinding;
  ...
  public void addContainer() {
    callBinding =
        ChatMessageCallViewHolderBinding.inflate(
