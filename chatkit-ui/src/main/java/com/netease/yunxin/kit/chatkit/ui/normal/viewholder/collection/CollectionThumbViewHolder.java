...
import com.netease.yunxin.kit.chatkit.ui.databinding.CollectionThumbnailViewHolderBinding;
...
/** 收藏消息图片和视频消息基类view holder */
public abstract class CollectionThumbViewHolder extends CollectionBaseViewHolder {
  private static final String TAG = "ChatThumbBaseViewHolder";

  CollectionThumbnailViewHolderBinding binding;

  public CollectionThumbViewHolder(@NonNull CollectionBaseViewHolderBinding parent, int viewType) {
  ...
  public void addContainer() {
    binding =
        CollectionThumbnailViewHolderBinding.inflate(
