...
public class ChatImagePinViewHolder extends ChatThumbPinViewHolder {
  private static final String TAG = "ChatImagePinViewHolder";

  public ChatImagePinViewHolder(@NonNull ChatBasePinViewHolderBinding parent, int viewType) {
