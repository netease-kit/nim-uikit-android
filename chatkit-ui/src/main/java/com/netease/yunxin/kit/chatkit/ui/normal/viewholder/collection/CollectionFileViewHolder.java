...
import com.netease.yunxin.kit.chatkit.ui.databinding.CollectionFileViewHolderBinding;
import com.netease.yunxin.kit.chatkit.ui.model.CollectionBean;
import com.netease.yunxin.kit.common.utils.FileUtils;

public class CollectionFileViewHolder extends CollectionBaseViewHolder {

  private static final String TAG = "ChatFileCollectionViewHolder";
  private CollectionFileViewHolderBinding binding;
  private static final int PROGRESS_MAX = 100;

  public CollectionFileViewHolder(@NonNull CollectionBaseViewHolderBinding parent, int viewType) {
  ...
  public void addContainer() {
    super.addContainer();
    binding =
        CollectionFileViewHolderBinding.inflate(
