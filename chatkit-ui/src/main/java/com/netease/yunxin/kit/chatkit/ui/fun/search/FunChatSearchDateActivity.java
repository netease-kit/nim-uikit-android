...
public class FunChatSearchDateActivity extends FunDateSelectActivity {

  private static final String TAG = "FunChatSearchDateActivity";
            ...
            result -> {
              if (result.isSuccess()) {
                ...
                XKitRouter.withKey(routerPath)
                    ...
                    .withContext(FunChatSearchDateActivity.this)
                    .navigate();
              }
              finish();
            });
  ...
  protected void onSelectDate(long selectedDate) {
    super.onSelectDate(selectedDate);
