...
public class ChatMessageForwardConfirmDialog extends BaseDialog {
    ...
    protected View getRootView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container) {
        ...
        if (getArguments() != null) {
            ...
            binding.tvMessage.setText(String.format(getString(R.string.chat_message_session_info), sendUser));
        }
    ...
    public static class UserAdapter extends CommonMoreAdapter<String, ChatUserSelectedItemLayoutBinding> {
        ...
        @NonNull
        @Override
        public BaseMoreViewHolder<String, ChatUserSelectedItemLayoutBinding> getViewHolder(@NonNull ViewGroup parent, int viewType) {
            ChatUserSelectedItemLayoutBinding viewBinding = ChatUserSelectedItemLayoutBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
