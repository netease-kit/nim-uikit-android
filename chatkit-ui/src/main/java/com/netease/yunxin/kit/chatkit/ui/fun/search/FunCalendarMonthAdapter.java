...
public class FunCalendarMonthAdapter
    extends RecyclerView.Adapter<FunCalendarMonthAdapter.MonthViewHolder> {
  ...
  class DayGridAdapter extends RecyclerView.Adapter<DayGridAdapter.DayViewHolder> {
    ...
    public DayViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      View v =
          LayoutInflater.from(parent.getContext())
              .inflate(R.layout.fun_chat_calendar_day_item, parent, false);
