...
import com.netease.yunxin.kit.chatkit.ui.databinding.CollectionAudioViewHolderBinding;
...
/** 收藏列表中语音消息ViewHolder */
public class CollectionAudioViewHolder extends CollectionBaseViewHolder {

  // 语音消息布局
  private CollectionAudioViewHolderBinding audioBinding;
  ...
  public CollectionAudioViewHolder(@NonNull CollectionBaseViewHolderBinding parent, int viewType) {
  ...
  public void addContainer() {
    audioBinding =
        CollectionAudioViewHolderBinding.inflate(
