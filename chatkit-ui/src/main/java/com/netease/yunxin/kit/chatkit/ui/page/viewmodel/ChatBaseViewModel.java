...
import com.netease.nimlib.coexist.sdk.v2.message.V2NIMClearHistoryNotification;
...
import com.netease.nimlib.coexist.sdk.v2.message.V2NIMMessageDeletedNotification;
import com.netease.nimlib.coexist.sdk.v2.message.V2NIMMessagePin;
import com.netease.nimlib.coexist.sdk.v2.message.V2NIMMessagePinNotification;
import com.netease.nimlib.coexist.sdk.v2.message.V2NIMMessageQuickCommentNotification;
import com.netease.nimlib.coexist.sdk.v2.message.V2NIMMessageRefer;
import com.netease.nimlib.coexist.sdk.v2.message.V2NIMP2PMessageReadReceipt;
import com.netease.nimlib.coexist.sdk.v2.message.V2NIMTeamMessageReadReceipt;
...
import com.netease.nimlib.coexist.sdk.v2.message.enums.V2NIMMessageAIRegenOpType;
import com.netease.nimlib.coexist.sdk.v2.message.enums.V2NIMMessageAIStreamStopOpType;
import com.netease.nimlib.coexist.sdk.v2.message.enums.V2NIMMessagePinState;
import com.netease.nimlib.coexist.sdk.v2.message.enums.V2NIMMessageQueryDirection;
...
import com.netease.nimlib.coexist.sdk.v2.message.option.V2NIMMessageListOption;
import com.netease.nimlib.coexist.sdk.v2.message.params.V2NIMAddCollectionParams;
import com.netease.nimlib.coexist.sdk.v2.message.params.V2NIMMessageAIRegenParams;
import com.netease.nimlib.coexist.sdk.v2.message.params.V2NIMMessageAIStreamStopParams;
import com.netease.nimlib.coexist.sdk.v2.message.params.V2NIMSendMessageParams;
import com.netease.nimlib.coexist.sdk.v2.message.params.V2NIMVoiceToTextParams;
...
import com.netease.yunxin.kit.corekit.coexist.im2.provider.V2MessageProvider;
import java.io.File;
