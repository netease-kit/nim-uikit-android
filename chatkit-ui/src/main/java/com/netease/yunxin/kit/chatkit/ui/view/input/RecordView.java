...
public class RecordView extends FrameLayout {
    ...
    private boolean isCancelled(View view, MotionEvent event) {
        ...
        return !isInCircle(event.getRawX(), event.getRawY(), location[0] + radius, location[1] + radius, radius);
    }
    ...
    protected void startRecord() {
        ...
        Animation waveAnimator = AnimationUtils.loadAnimation(getContext(), R.anim.anim_record_button_wave);
