...
import com.netease.yunxin.kit.chatkit.ui.databinding.FunChatSearchMemberActivityBinding;
...
public class FunChatSearchMemberActivity extends ChatSearchByMemberBaseActivity {

  private static final String TAG = "FunChatSearchMemberActivity";

  private FunChatSearchMemberActivityBinding binding;
  ...
  protected void initViewAndSetContentView(@Nullable Bundle savedInstanceState) {
    binding = FunChatSearchMemberActivityBinding.inflate(getLayoutInflater());
  ...
  protected void startMemberSelector(ActivityResultLauncher<Intent> launcher) {
    ...
    XKitRouter.withKey(RouterConstant.PATH_FUN_TEAM_MEMBER_LIST_PAGE)
