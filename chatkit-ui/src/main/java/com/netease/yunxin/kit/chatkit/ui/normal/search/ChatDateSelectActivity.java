...
import com.netease.yunxin.kit.chatkit.ui.databinding.ChatCalendarRangeActivityBinding;
import com.netease.yunxin.kit.common.ui.activities.BaseLocalActivity;
import com.netease.yunxin.kit.common.ui.widgets.datepicker.CustomDatePicker;
import java.util.ArrayList;
import java.util.Calendar;

public class ChatDateSelectActivity extends BaseLocalActivity {

  protected final long Days7Diff = 7L * 24 * 60 * 60 * 1000;
  protected final long Days30Diff = 30L * 24 * 60 * 60 * 1000;
  protected final int minYear = 1970;
  protected ChatCalendarRangeActivityBinding binding;
  protected Long selectedDay;
  private Long monthTitleSelected;

  protected Long todayLocal;
  protected TextView tvMonthTitle;
  protected ImageView ivMonthDropdown;
  protected RecyclerView rvCalendar;
  protected CalendarMonthAdapter calendarMonthAdapter;
  protected ArrayList<Calendar> months;
  protected LinearLayoutManager calendarLayoutManager;

  @Override
  protected void onCreate(Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
    binding = ChatCalendarRangeActivityBinding.inflate(getLayoutInflater());
