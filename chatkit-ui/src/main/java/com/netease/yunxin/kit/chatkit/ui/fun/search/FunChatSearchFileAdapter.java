...
public class FunChatSearchFileAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public FunChatSearchFileAdapter(Context context, List<MessageGroup> fileGroups) {
  ...
  public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
    if (holder instanceof FooterViewHolder) {
      ALog.i("FunChatSearchFileAdapter", "FooterViewHolder: " + footerLoading);
  ...
  class FileListAdapter extends RecyclerView.Adapter<FileListAdapter.FileViewHolder> {
    ...
    public FileViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
      FunChatSearchFileItemBinding binding =
          FunChatSearchFileItemBinding.inflate(LayoutInflater.from(context), parent, false);
    ...
    public void onBindViewHolder(@NonNull FileViewHolder holder, int position) {
      ...
      if (ext == null || ext.isEmpty()) {
        ext = com.netease.yunxin.kit.common.utils.FileUtils.getFileExtension(attachment.getName());
      }
    ...
    class FileViewHolder extends RecyclerView.ViewHolder {
      ...
      public FileViewHolder(@NonNull FunChatSearchFileItemBinding binding) {
        super(binding.getRoot());
        this.binding = binding;
      }
    }
