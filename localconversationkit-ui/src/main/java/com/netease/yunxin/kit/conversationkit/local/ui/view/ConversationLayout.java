...
import com.netease.yunxin.kit.conversationkit.local.ui.databinding.LocalConversationViewLayoutBinding;

/** 会话列表布局，整个页面的布局都封装在该View中 包括标题栏、会话列表、底部布局等 */
public class ConversationLayout extends LinearLayout {

  private LocalConversationViewLayoutBinding viewBinding;
  ...
  private void init(AttributeSet attrs) {
    ...
    viewBinding = LocalConversationViewLayoutBinding.inflate(layoutInflater, this);
  }
