...
import com.netease.yunxin.kit.conversationkit.local.ui.fun.viewholder.FunConversationHeaderViewHolder;
import com.netease.yunxin.kit.conversationkit.local.ui.fun.viewholder.FunConversationP2PViewHolder;
import com.netease.yunxin.kit.conversationkit.local.ui.fun.viewholder.FunConversationTeamViewHolder;
...
public class FunViewHolderFactory implements ILocalConversationFactory {
  ...
  public BaseViewHolder<ConversationBean> createViewHolder(
    ...
    if (viewType == ConversationConstant.ViewType.HORIZON_VIEW) {
      ...
      FunLocalConversationViewHolderBinding binding =
          FunLocalConversationViewHolderBinding.inflate(
              LayoutInflater.from(parent.getContext()), parent, false);
