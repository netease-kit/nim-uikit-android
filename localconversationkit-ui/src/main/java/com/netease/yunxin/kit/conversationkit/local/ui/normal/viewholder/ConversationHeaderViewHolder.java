...
import com.netease.yunxin.kit.conversationkit.local.ui.normal.ConversationTopAdapter;
...
public class ConversationHeaderViewHolder extends BaseViewHolder<ConversationBean> {
  ...
  public ConversationHeaderViewHolder(@NonNull LocalConversationHeaderLayoutBinding viewBinding) {
    super(viewBinding);
