...
public class SearchViewHolderFactory implements IViewHolderFactory {
    ...
    public BaseViewHolder createViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if(viewType == SearchConstant.ViewType.TITLE){ //title view
            return new TitleViewHolder(SearchTitleItemLayoutBinding.inflate(LayoutInflater.from(parent.getContext()),parent,false));
        }else if (viewType == SearchConstant.ViewType.USER){ // friend view
            return new FriendViewHolder(SearchUserItemLayoutBinding.inflate(LayoutInflater.from(parent.getContext()),parent,false));
        }else if (viewType == SearchConstant.ViewType.TEAM){ //team view
            return new TeamViewHolder(SearchUserItemLayoutBinding.inflate(LayoutInflater.from(parent.getContext()),parent,false));
