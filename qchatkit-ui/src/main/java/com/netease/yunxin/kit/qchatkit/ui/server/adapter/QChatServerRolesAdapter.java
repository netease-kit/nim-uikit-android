...
public class QChatServerRolesAdapter extends CommonMoreAdapter<QChatServerRoleInfo, QChatServerRoleViewHolderBinding> {
    ...
    @NonNull
    @Override
    public BaseMoreViewHolder<QChatServerRoleInfo, QChatServerRoleViewHolderBinding> getViewHolder(@NonNull ViewGroup parent, int viewType) {
        QChatServerRoleViewHolderBinding binding = QChatServerRoleViewHolderBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull BaseMoreViewHolder<QChatServerRoleInfo, QChatServerRoleViewHolderBinding> holder, int position) {
