...
public class QChatRoleListActivity extends CommonActivity {
    ...
    public void initView() {
        ...
        binding.clEveryone.setOnClickListener(v -> {
    ...
    public void initData() {
        ...
        CommonMoreRecyclerViewDecorator<QChatServerRoleInfo> decorator = new CommonMoreRecyclerViewDecorator<>(binding.rvRoles, layoutManager, rolesAdapter);
    ...
    private void getRolesList(long timeTag) {
        QChatRoleRepo.fetchServerRoles(serverInfo.getServerId(), timeTag, PAGE_SIZE, new QChatCallback<ServerRoleResult>(getApplicationContext()) {
            @Override
