...
/**
 * role permission activity
 * modify role's permission in channel
 */
public class QChatRolePermissionActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        viewModel.getRolePermissionLiveData().observe(this, result -> {
    ...
    private void initView() {
        viewBiding.qChatRolePermissionTitleBar.setOnBackIconClickListener(view -> {
            finish();
        });
        if (roleInfo != null) {
    ...
    private void loadPermissionData(){
        ...
        if (auth.size() > 0) {
            ...
            if (optionManagerRole != null) {
                ...
                viewBiding.qChatRolePermissionAttrSwitch.setOnClickListener(view -> switchChange(QChatRoleResourceEnum.MANAGE_CHANNEL, viewBiding.qChatRolePermissionAttrSwitch.getCurrentStatus()));
            }
            ...
            if (optionManagerChannel != null) {
                ...
                viewBiding.qChatRolePermissionChannelSwitch.setOnClickListener(view -> switchChange(QChatRoleResourceEnum.MANAGE_ROLE, viewBiding.qChatRolePermissionChannelSwitch.getCurrentStatus()));
            }
            ...
            if (optionSendMsg != null) {
                ...
                viewBiding.qChatRolePermissionSendMessageSwitch.setOnClickListener(view -> switchChange(QChatRoleResourceEnum.SEND_MSG, viewBiding.qChatRolePermissionSendMessageSwitch.getCurrentStatus()));
            }

            QChatRoleOptionEnum optionMemberSelf = auth.get(QChatRoleResourceEnum.MANAGE_BLACK_WHITE_LIST);
            if (optionMemberSelf != null) {
                viewBiding.qChatRolePermissionManagerMemberSwitch.setStatus(optionMemberSelf.ordinal());
                viewBiding.qChatRolePermissionManagerMemberSwitch.setOnClickListener(view -> switchChange(QChatRoleResourceEnum.MANAGE_BLACK_WHITE_LIST, viewBiding.qChatRolePermissionManagerMemberSwitch.getCurrentStatus()));
            }
        }
    }
    ...
    private void switchChange(QChatRoleResourceEnum type, int value) {
        ...
        viewModel.updateChannelRole(roleInfo.getServerId(), roleInfo.getChannelId(), roleInfo.getRoleId(), valueMap);
    }
