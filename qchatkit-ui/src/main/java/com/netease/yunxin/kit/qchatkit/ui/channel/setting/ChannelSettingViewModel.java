...
public class ChannelSettingViewModel extends BaseViewModel {
    ...
    public void fetchChannelInfo(long channelId){
        ...
        QChatChannelRepo.fetchChannelInfo(channelId, new FetchCallback<List<QChatChannelInfo>>() {
            ...
            public void onException(@Nullable Throwable exception) {
                fetchResult.setError(QChatConstant.ERROR_CODE_CHANNEL_FETCH, R.string.qchat_channel_fetch_error);
                resultLiveData.postValue(fetchResult);
    ...
    public void deleteChannel(long channelId){
        ...
        QChatChannelRepo.deleteChannel(channelId, new FetchCallback<Void>() {
            @Override
            ...
            @Override
            public void onException(@Nullable Throwable exception) {
                fetchResult.setError(QChatConstant.ERROR_CODE_CHANNEL_DELETE, R.string.qchat_channel_delete_error);
                resultLiveData.postValue(fetchResult);
            }
        });
    }
    ...
    public void updateChannel(@NonNull long channelId,@NonNull String name,@NonNull String topic){
        ...
        QChatChannelRepo.updateChannel(channelId,name,topic, new FetchCallback<QChatChannelInfo>() {
            @Override
            ...
            @Override
            public void onException(@Nullable Throwable exception) {
                fetchResult.setError(QChatConstant.ERROR_CODE_CHANNEL_DELETE, R.string.qchat_channel_update_error);
                resultLiveData.postValue(fetchResult);
            }
        });
    }
