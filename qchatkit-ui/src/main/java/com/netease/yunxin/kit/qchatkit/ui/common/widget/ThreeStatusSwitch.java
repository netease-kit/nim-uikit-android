...
public class ThreeStatusSwitch extends LinearLayout implements View.OnClickListener {
    ...
    public ThreeStatusSwitch(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(){
        ...
        viewBinding = QChatThreeStatusSwitchLayoutBinding.inflate(LayoutInflater.from(getContext()),this);
    ...
    private void switchStatus(int value){
        ...
        switch (value){
            case SWITCH_CLOSE:
                viewBinding.qchatThreeStatusCloseLayout.setBackgroundResource(R.drawable.bg_shape_qchat_switch_left);
                viewBinding.qchatThreeStatusCloseIv.setImageResource(R.drawable.ic_white_close);
                currentStatus = SWITCH_CLOSE;
                break;
            case SWITCH_NEUTRAL:
                viewBinding.qchatThreeStatusNeutralLayout.setBackgroundResource(R.drawable.bg_shape_qchat_switch_center);
                viewBinding.qchatThreeStatusNeutralIv.setImageResource(R.drawable.ic_white_neutral);
                currentStatus = SWITCH_NEUTRAL;
                break;
            case SWITCH_OPEN:
                viewBinding.qchatThreeStatusOpenLayout.setBackgroundResource(R.drawable.bg_shape_qchat_switch_right);
