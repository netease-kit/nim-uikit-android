...
public class QChatCommonAdapter<T, R extends ViewBinding> extends RecyclerView.Adapter<QChatCommonAdapter.ItemViewHolder<R>> {
    ...
    public QChatCommonAdapter(Context context, Class<R> viewBinding) {
        ...
        try {
            inflateMethod = viewBinding.getMethod(NAME_METHOD_INFLATE, LayoutInflater.class, ViewGroup.class, boolean.class);
