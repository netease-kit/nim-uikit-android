...
/**
 * channel setting activity
 * you can modify channel name,channel topic
 */
public class ChannelSettingActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        viewBinding.channelSettingPermissionRtv.setOnClickListener(view -> {
            ...
            if (checkParamValid()) {
                ...
                Toast.makeText(this, getResources().getString(R.string.qchat_channel_empty_error), Toast.LENGTH_SHORT).show();
            }
        });

        viewBinding.channelSettingWhiteNameListRtv.setOnClickListener(view -> {
            ALog.d(TAG, "OnClickListener","channelSettingWhiteNameListRtv"+checkParamValid());
            if (checkParamValid()) {
                QChatBlackWhiteActivity.launch(this, channelInfo.getServerId(), channelId, this.channelInfo.getViewMode().ordinal());
            }else {
                Toast.makeText(this, getResources().getString(R.string.qchat_channel_empty_error), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void updateChannelSetting() {
        if (channelInfo != null){
            ...
            if (!TextUtils.isEmpty(channelName)){
                ...
                Toast.makeText(this, getString(R.string.qchat_channel_update_empty_error), Toast.LENGTH_SHORT).show();
            }
        }
    }
