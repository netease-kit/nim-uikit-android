...
/**
 * member permission view mode
 * get or update member permission
 */
public class MemberPermissionViewModel extends BaseViewModel {
     ...
     */
    public void updateMemberRole(long serverId, long channelId, String accId, Map<QChatRoleResourceEnum, QChatRoleOptionEnum> options) {
        ALog.d(TAG, "updateMemberRole");
        QChatRoleRepo.updateChannelMember(serverId, channelId, accId, options, new FetchCallback<QChatChannelMember>() {
            @Override
            ...
            public void onException(@Nullable Throwable exception) {
                ...
                addResult.setError(QChatConstant.ERROR_CODE_CHANNEL_MEMBER_ADD, R.string.qchat_channel_permission_update_error);
                addLiveData.postValue(addResult);
            }
        });
    }
