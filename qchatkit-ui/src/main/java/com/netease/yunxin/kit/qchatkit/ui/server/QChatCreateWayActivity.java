...
public class QChatCreateWayActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        binding.tvCreateSelf.setOnClickListener(v -> {
        ...
        binding.tvJoinOther.setOnClickListener(v -> {
            launcher.launch(new Intent(QChatCreateWayActivity.this, QChatJoinOtherServerActivity.class));
            overridePendingTransition(R.anim.anim_from_end_to_start, R.anim.anim_empty_with_time);
        });
    }
