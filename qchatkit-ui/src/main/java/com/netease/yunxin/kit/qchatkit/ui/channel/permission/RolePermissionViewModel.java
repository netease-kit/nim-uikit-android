...
/**
 * role permission view mode
 * get or update role permission
 */
public class RolePermissionViewModel extends BaseViewModel {
     ...
     */
    public void updateChannelRole(long serverId, long channelId, long roleId, Map<QChatRoleResourceEnum, QChatRoleOptionEnum> options) {
        ALog.d(TAG, "updateChannelRole", "info:" + serverId + "," + channelId + "," + roleId);
        QChatRoleRepo.updateChannelRole(serverId, channelId, roleId, options, new FetchCallback<QChatChannelRoleInfo>() {
            @Override
            ...
            public void onException(@Nullable Throwable exception) {
                ...
                rolePermissionResult.setError(QChatConstant.ERROR_CODE_CHANNEL_MEMBER_ADD, R.string.qchat_channel_permission_update_error);
                rolePermissionLiveData.postValue(rolePermissionResult);
            }
        });
    }
