...
public class TeamInfoActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding.tvIcon.setOnClickListener(v -> TeamUpdateIconActivity.launch(TeamInfoActivity.this, hasUpdatePrivilege, teamId, teamIconUrl, launcher));
        binding.tvName.setOnClickListener(v -> TeamUpdateNameActivity.launch(TeamInfoActivity.this, hasUpdatePrivilege, teamTypeEnum, teamId, teamName, launcher));
        binding.tvIntroduce.setOnClickListener(v -> TeamUpdateIntroduceActivity.launch(TeamInfoActivity.this, hasUpdatePrivilege, teamId, teamIntroduce, launcher));
    ...
    public static void launch(Context context, boolean hasUpdatePrivilege, TeamTypeEnum teamTypeEnum,
                              String teamId, String teamName, String teamIntroduce, String teamIcon,
