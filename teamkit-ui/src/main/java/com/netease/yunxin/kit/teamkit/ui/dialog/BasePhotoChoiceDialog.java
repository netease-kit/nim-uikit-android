        ...
        takePhotoView.setOnClickListener(
                v -> {
                    if (!NetworkUtils.isConnected()) {
                        Toast.makeText(getContext(), com.netease.yunxin.kit.common.ui.R.string.common_network_error, Toast.LENGTH_SHORT).show();
                        return;
                    }
                                        ...
                                        public void onGranted(List<String> permissionsGranted) {
                                            if (permissionsGranted != null
                                                ...
                                                PhotoPicker.getInstance()
                                                        .takePhotoCorpAndUpload(getContext(), localCallback);
                                            } else {
                                                Toast.makeText(
                                                                getContext(),
                                                                getContext()
                                                                        .getResources()
                                                                        .getString(com.netease.yunxin.kit.common.ui.R.string.dialog_permission_tips),
                                                                Toast.LENGTH_SHORT)
                                                        .show();
                                            }
                                        }
